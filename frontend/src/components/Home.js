...
const Home = () => {
  return (
    <div className="container">
      ...
      <div style={{border:'2px solid #242222cf',borderRadius:'14px'}} className="container">
      <form>
        <div className="form-group my-3">
          <label htmlFor="email" style={{fontWeight:'bold',fontFamily:'sans-serif'}}>Email address</label>
          <input
            type="email"
        ...
        <div className="form-group my-3">
          <label htmlFor="password" style={{fontWeight:'bold',fontFamily:'sans-serif'}}>Password</label>
          <input
            type="password"
            className="form-control"
            id="password"
